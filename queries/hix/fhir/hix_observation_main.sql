-- HIX general Observation query
-- Covers clinical observations that are not lab results or vital-sign measurements.
-- Template vars: .effective_from / .effective_to  (FHIR date param → Observation.effective)
--                .status                          (FHIR status param)
--                .code                            (FHIR code param   → Observation.code)
--                .category                        (FHIR category param)
